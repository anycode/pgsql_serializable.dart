...
class PgSqlConverterNamedCtor<E> {
  ...
  static Duration _fromPgSql(int value) => null;
...
class _ConverterWithCtorParams implements PgSqlConverter<Duration, int> {
  ...
  @override
  Duration fromPgSql(int pgsql) => null;
...
class _NeedsConversionConverter
    implements PgSqlConverter<_NeedsConversion, int> {
  const _NeedsConversionConverter();

  @override
  _NeedsConversion fromPgSql(int pgsql) => _NeedsConversion();
