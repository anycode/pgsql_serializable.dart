...
import 'package:pgsql_serializable/src/helper_core.dart';
...
GeneralTestClass1 _$GeneralTestClass1FromPgSql(Map<String, dynamic> pgsql) {
  return GeneralTestClass1()
    ...
    ..listOfInts = (pgsql['listOfInts'] as List)?.map((e) => e as int)?.toList();
}
...
SetSupport _$SetSupportFromPgSql(Map<String, dynamic> pgsql) {
  return SetSupport(
    (pgsql['values'] as List)?.map((e) => e as int)?.toSet(),
  );
}
...
class NoCtorClass {
  ...
  factory NoCtorClass.fromPgSql(Map<String, dynamic> pgsql) => null;
}
...
class ExtraParamFromPgSqlCtor {
  ...
  Map<String, dynamic> toPgSql() => null;
}
...
class ExtraParamToPgSql {
  ...
  Map<String, dynamic> toPgSql(int bob) => null;
}
