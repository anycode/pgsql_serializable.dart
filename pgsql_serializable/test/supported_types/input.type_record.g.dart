...
SimpleClassOfBool _$SimpleClassOfBoolFromPgSql(Map<String, dynamic> pgsql) =>
    SimpleClassOfBool(
      _$recordConvert(
        pgsql['value'],
        ($pgsqlValue) =>
            ($pgsqlValue[r'$1'] as bool, named: $pgsqlValue['named'] as bool),
      ),
    );
...
SimpleClassOfDuration _$SimpleClassOfDurationFromPgSql(
  ...
  _$recordConvert(
    pgsql['value'],
    ($pgsqlValue) => (
      Duration(microseconds: ($pgsqlValue[r'$1'] as num).toInt()),
      named: Duration(microseconds: ($pgsqlValue['named'] as num).toInt()),
    ),
  ),
);
...
SimpleClassOfDurationNullable _$SimpleClassOfDurationNullableFromPgSql(
  ...
  _$recordConvert(
    ...
    ($pgsqlValue) => (
      ...
      named: $pgsqlValue['named'] == null
          ? null
          : Duration(microseconds: ($pgsqlValue['named'] as num).toInt()),
    ),
  ),
);
...
SimpleClassOfDynamic _$SimpleClassOfDynamicFromPgSql(
  ...
  _$recordConvert(
    pgsql['value'],
    ($pgsqlValue) => ($pgsqlValue[r'$1'], named: $pgsqlValue['named']),
  ),
);
    ...
    SimpleClassOfInt(
      _$recordConvert(
        ...
        ($pgsqlValue) => (
          ...
          named: ($pgsqlValue['named'] as num).toInt(),
        ),
      ),
    );
...
SimpleClassOfNum _$SimpleClassOfNumFromPgSql(Map<String, dynamic> pgsql) =>
    SimpleClassOfNum(
      _$recordConvert(
        pgsql['value'],
        ($pgsqlValue) =>
            ($pgsqlValue[r'$1'] as num, named: $pgsqlValue['named'] as num),
      ),
    );
...
SimpleClassOfObject _$SimpleClassOfObjectFromPgSql(Map<String, dynamic> pgsql) =>
    SimpleClassOfObject(
      _$recordConvert(
        pgsql['value'],
        ($pgsqlValue) =>
            ($pgsqlValue[r'$1'] as Object, named: $pgsqlValue['named'] as Object),
      ),
    );
...
SimpleClassOfString _$SimpleClassOfStringFromPgSql(Map<String, dynamic> pgsql) =>
    SimpleClassOfString(
      _$recordConvert(
        pgsql['value'],
        ($pgsqlValue) =>
            ($pgsqlValue[r'$1'] as String, named: $pgsqlValue['named'] as String),
      ),
    );
...
SimpleClassOfUriNullable _$SimpleClassOfUriNullableFromPgSql(
  ...
  _$recordConvert(
    pgsql['value'],
    ($pgsqlValue) => (
      $pgsqlValue[r'$1'] == null ? null : Uri.parse($pgsqlValue[r'$1'] as String),
      named: $pgsqlValue['named'] == null
          ? null
