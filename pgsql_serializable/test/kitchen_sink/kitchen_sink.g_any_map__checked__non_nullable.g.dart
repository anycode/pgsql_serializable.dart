...
KitchenSink _$KitchenSinkFromPgSql(Map pgsql) {
  return $checkedNew('KitchenSink', pgsql, () {
    final val = KitchenSink(
      ...
      iterable: $checkedConvert(pgsql, 'iterable', (v) => v as List),
      dynamicIterable:
          $checkedConvert(pgsql, 'dynamicIterable', (v) => v as List),
      objectIterable: $checkedConvert(pgsql, 'objectIterable', (v) => v as List),
      intIterable: $checkedConvert(
          pgsql, 'intIterable', (v) => (v as List).map((e) => e as int)),
      dateTimeIterable: $checkedConvert(pgsql, 'datetime-iterable',
          (v) => (v as List).map((e) => DateTime.parse(e as String))),
    );
    $checkedConvert(
        pgsql, 'dateTime', (v) => val.dateTime = DateTime.parse(v as String));
    $checkedConvert(
        pgsql, 'bigInt', (v) => val.bigInt = BigInt.parse(v as String));
    $checkedConvert(pgsql, 'set', (v) => val.set = (v as List).toSet());
    $checkedConvert(
        pgsql, 'dynamicSet', (v) => val.dynamicSet = (v as List).toSet());
    $checkedConvert(
        pgsql, 'objectSet', (v) => val.objectSet = (v as List).toSet());
    ...
    $checkedConvert(pgsql, 'list', (v) => val.list = v as List);
    $checkedConvert(pgsql, 'dynamicList', (v) => val.dynamicList = v as List);
    $checkedConvert(pgsql, 'objectList', (v) => val.objectList = v as List);
    $checkedConvert(pgsql, 'intList',
...
PgSqlConverterTestClass _$PgSqlConverterTestClassFromPgSql(Map pgsql) {
  return $checkedNew('PgSqlConverterTestClass', pgsql, () {
    ...
    $checkedConvert(pgsql, 'duration',
        (v) => val.duration = durationConverter.fromPgSql(v as int));
    $checkedConvert(
        pgsql,
        'durationList',
    ...
    $checkedConvert(
        ...
        'bigInt',
        (v) =>
            val.bigInt = const BigIntStringConverter().fromPgSql(v as String));
    $checkedConvert(
        pgsql,
        'bigIntMap',
    ...
    $checkedConvert(
        ...
        'numberSilly',
        (v) => val.numberSilly =
            TrivialNumberConverter.instance.fromPgSql(v as int));
    $checkedConvert(
        pgsql,
        'numberSillySet',
    ...
    $checkedConvert(
        ...
        'dateTime',
        (v) =>
            val.dateTime = const EpochDateTimeConverter().fromPgSql(v as int));
    return val;
  });
}
