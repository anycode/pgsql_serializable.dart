...
void main() {
  ...
  test('triggers config is ignored', () async {
    ...
    // check it doesn't cause pgsql_serializable's config validation to throw.
    pgsqlSerializable(const BuilderOptions({'run_only_if_triggered': true}));
  });
