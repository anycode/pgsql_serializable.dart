  ...
  return Person(
    ...
    ..customOrders = pgsql['customOrders'] == null
        ...
        : MyList.fromPgSql((pgsql['customOrders'] as List)
            ?.map((e) =>
                e == null ? null : Order.fromPgSql(e as Map<String, dynamic>))
            ?.toList())
...
Order _$OrderFromPgSql(Map<String, dynamic> pgsql) {
  ...
  return Order(
    ...
    (pgsql['items'] as List)?.map(
        (e) => e == null ? null : Item.fromPgSql(e as Map<String, dynamic>)),
  )
    ...
    ..altPlatforms = (pgsql['altPlatforms'] as Map<String, dynamic>)?.map(
      (k, e) => MapEntry(k, e == null ? null : Platform.fromPgSql(e as String)),
    )
    ..homepage =
