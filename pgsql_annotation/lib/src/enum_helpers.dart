...
///
/// Exposed only for code generated by `package:pgsql_serializable`.
...
K? $enumDecodeNullable<K extends Enum, V>(
  ...
  if (unknownValue == PgSqlKey.nullForUndefinedEnumValue) {
    return null;
  }
  ...
  if (unknownValue is! K) {
    throw ArgumentError.value(
      unknownValue,
      'unknownValue',
      'Must by of type `$K` or `PgSqlKey.nullForUndefinedEnumValue`.',
    );
  }
